...
const AboutMe: FC<AboutMeProps> = ({ data: aboutMeData, error }) => (
  <>
    ...
    <main className="flex h-96 flex-col items-center overflow-y-scroll border border-black px-12 pt-3 pb-6 grid-in-about-me scrollbar scrollbar-thumb-black dark:border-white dark:scrollbar-track-black dark:scrollbar-thumb-white md:py-7 md:px-4 xl:h-auto xl:py-7">
