export default {
  DESCRIPTION: `Hi there! My name is Matej and I am **self-taught developer** with over **5+ years of experience** in many different fields of programming! I come from Rijeka, a **beautiful city that flows** in Croatia!\\
  \\
