...
const MeImage: FC<MeImageProps> = ({ src, alt, keys, currentImageIndex, next, prev, dotClick }) => (
  <div className="relative max-w-full flex-shrink-0 border-b border-black object-cover dark:border-white md:h-80 md:w-80 md:border-b-0">
    ...
    <img src={src} alt={alt} width={800} height={600} className="h-auto w-full object-cover" />
    <button
      type="button"
